...
namespace ns13
{
  ...
  {
    public const string string_4 = "attrib_hh_face_geombuild-attrib_entity_geombuild-individual_entity_attribute-attrib_HH-attrib";
    private Class686.Class688 class688_0;

    public override string imethod_2(int version)
    {
      return "attrib_hh_face_geombuild-attrib_entity_geombuild-individual_entity_attribute-attrib_HH-attrib";
    }
