...
namespace ns35
{
  internal class Class990 : Interface29
  {
    ...
    public Encoding Encoding
    {
      get
      {
        return this.interface40_1.Encoding;
      }
    }
    ...
    public Encoding EffectiveEncoding
    {
      get
      {
        return this.interface40_1.EffectiveEncoding;
      }
    }

    public void Flush()
    {
      long bitPosition = this.interface40_0.imethod_48();
      long lengthInBits = this.interface40_1.imethod_48();
      this.interface40_0.Flush();
      if (this.bool_0)
      {
        int num = (int) (bitPosition + lengthInBits + 1L);
        if (lengthInBits > 0L)
        {
          num += 16;
      ...
      this.interface40_0.imethod_47(bitPosition);
      if (lengthInBits > 0L)
      {
        ...
        this.interface40_0.Flush();
        this.interface40_0.imethod_47(bitPosition + lengthInBits);
        this.interface40_0.imethod_50(lengthInBits);
        this.interface40_0.imethod_14(true);
      }
      else
        this.interface40_0.imethod_14(false);
      this.interface40_2.Flush();
      this.long_1 = this.interface40_0.imethod_48();
      this.interface40_0.imethod_13(((MemoryStream) this.interface40_2.Stream).GetBuffer(), 0, (int) this.interface40_2.Stream.Length);
      this.interface40_0.Flush();
    }
    ...
    {
      this.interface40_1.imethod_4(value);
    }
    ...
    {
      this.interface40_0.imethod_7((Interface29) this.interface40_1, color);
    }
