...
namespace ns28
{
  internal class Stream2 : Stream
  {
    ...
    {
      this.uint_0 = this.uint_0 >> 8 ^ Stream2.uint_1[(IntPtr) (uint) (((int) this.uint_0 ^ (int) value) & (int) byte.MaxValue)];
    }
    ...
    public override int Read(byte[] buffer, int offset, int count)
    {
      ...
      for (int index = offset; index < num2; ++index)
        this.uint_0 = this.uint_0 >> 8 ^ Stream2.uint_1[(IntPtr) (uint) (((int) this.uint_0 ^ (int) buffer[index]) & (int) byte.MaxValue)];
      return num1;
    }
