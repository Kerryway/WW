...
// Type: WW.OpenGL.Actions.InteractorGLDrawable
...
{
  public class InteractorGLDrawable : IInteractorGLDrawable
  {
    public virtual void Draw(GraphicsHelper graphicsHelper, InteractionContext context)
    {
    }
  }
}
